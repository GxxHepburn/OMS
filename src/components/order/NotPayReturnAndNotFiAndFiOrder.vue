<template>
    <div>
        ...
        <el-card>
          ...
          <el-radio-group v-model="queryInfo.timeStatus" @change="getNewOrderFormList">
            <el-radio-button label=1>今日</el-radio-button>
            <el-radio-button label=2>2天</el-radio-button>
            <el-radio-button label=3>3天</el-radio-button>
            <el-radio-button label=4>一周</el-radio-button>
            <el-radio-button label=5>30天</el-radio-button>
