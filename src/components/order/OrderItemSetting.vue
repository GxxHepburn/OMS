            ...
            <div class="bill-preview">
              ...
              <div id="printST" class="detail">
                ...
                <div v-for="item in orderDetailForm"><!-- eslint-disable-line -->
                  ...
                  <p>
                    <label  style="margin-right:20px;margin-left:60px"><span style="font-size:22px;">【<span style="font-size:20px;">x</span></span><span style="font-size:22px;">{{item.OD_RealNum}}</span><span style="font-size:22px;">】</span></label>￥<label style="font-size:20px">{{item.price}}</label>
                  </p>
                </div>
                <div style="border-bottom:#000 dashed 1px;"></div>
            ...
            <div class="bill-preview" v-for="item in orderAddFormList" :key="item.OA_ID">
              ...
              <div :id="'printST' + item.OA_Sort" class="detail">
                ...
                <div v-for="itemIn in item.orderDetails"><!-- eslint-disable-line -->
                  ...
                  <p>
                    <label  style="margin-right:20px;margin-left:60px"><span style="font-size:22px;">【<span style="font-size:20px;">x</span></span><span style="font-size:22px;">{{itemIn.OD_RealNum}}</span><span style="font-size:22px;">】</span></label>￥<label style="font-size:20px">{{itemIn.OD_RealPrice}}</label>
                  </p>
                </div>
                <div style="border-bottom:#000 dashed 1px;"></div>
                <p><label style="margin-right:50px;margin-left:80px;font-size:25px;">合计:</label><label style="font-size:25px;margin-left:20px;">￥{{item.OA_TotlePrice}}</label></p>
                <p>*************************************</p>
                <div style="border-bottom:#000 dashed 1px;"></div>
                <p><label>打印时间:</label><label style="font-size:13px;margin-left:10px;">{{new Date().toLocaleString()}}</label></p>
                <p><label>餐厅联系电话:</label><label style="font-size:13px;margin-left:10px;">{{merForm.m_Phone}}</label></p>
